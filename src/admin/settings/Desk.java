...
public class Desk extends javax.swing.JDialog {

    CardLayout c= new CardLayout();
    
    public Desk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        baseP.setLayout(c);
        baseP.add(firstP, "f");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Desk dialog = new Desk(new javax.swing.JFrame(), true);
