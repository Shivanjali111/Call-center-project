...
public class AddEmployee2 extends javax.swing.JDialog {

    public AddEmployee2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        baseP.setLayout(new java.awt.GridBagLayout());
        ...
        baseP.add(personalP, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 0, 20);
        baseP.add(addressP, gridBagConstraints);
        ...
        baseP.add(companyP, gridBagConstraints);
        ...
        baseP.add(jButton3, gridBagConstraints);
        ...
        baseP.add(jButton4, gridBagConstraints);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(baseP, javax.swing.GroupLayout.PREFERRED_SIZE, 660, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEmployee2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddEmployee2 dialog = new AddEmployee2(new javax.swing.JFrame(), true);
